...
public class Sketch : MonoBehaviour {
    ...
    void Start () {
        ...
        foreach (Town town in towns)
        {
            ...
            float latitude = town.Latitude;
            float altitude = town.Altitude;
            float longitude = town.Longitude;
            float Size = town.Size;
            string symbol = town.Symbol;

            var newCube = (GameObject)Instantiate(myPrefab, new Vector3(latitude, altitude, longitude), Quaternion.identity);
